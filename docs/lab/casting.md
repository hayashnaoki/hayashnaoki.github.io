...
1. Prototype:
  ...
  - Finished with UV resin and baby powder
   ...
   ![](/docs/images/lab/casting/prototype.jpg)
    ...
    <div class="image-grid">
      <a class="grid-item">
        <div class="image-wrapper">
          <img src="/docs/images/lab/casting/mold_making_1.jpg" class="bw" alt="">
        </div>
      </a>

      <a class="grid-item">
        <div class="image-wrapper">
          <img src="/docs/images/lab/casting/mold_making_2.jpg" class="bw" alt="">
        </div>
      </a>

      <a class="grid-item">
        <div class="image-wrapper">
          <img src="/docs/images/lab/casting/talc.jpg" class="bw" alt="">
        </div>
      </a>

      <a class="grid-item">
        <div class="image-wrapper">
          <img src="/docs/images/lab/casting/mold.jpg" class="bw" alt="">
        </div>
      </a>
    </div>
...
1. Casting:
    ...
    1. Melt the tin blocks in a pan
    1. Pour the tin

    Ref: [Sand casting blog](https://ma-kuimono.com/casting18/) / [YouTube](https://www.youtube.com/watch?v=3xQFHS7qyWc)
